 ...
 * This file demonstrates how to integrate Riftshard with a web frontend
 */

// For React/Vue/Angular applications
export class RiftshardClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new RiftshardClient(provider, contractAddress);
